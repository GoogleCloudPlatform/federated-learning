...
provider "registry.terraform.io/hashicorp/google" {
  version     = "4.68.0"
  constraints = ">= 3.43.0, >= 3.53.0, >= 4.20.0, >= 4.47.0, != 4.49.0, != 4.50.0, >= 4.51.0, != 4.65.0, != 4.65.1, < 5.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/google-beta" {
  version     = "4.68.0"
  constraints = ">= 3.43.0, >= 4.20.0, >= 4.47.0, != 4.49.0, != 4.50.0, >= 4.51.0, != 4.65.0, != 4.65.1, < 5.0.0"
  hashes = [
